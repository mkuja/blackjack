...
class Hand(db.Model):
    ...
    stay = db.Column(db.Boolean, default=False)  # Indicates whether player has played move "stay" on this hand.
    hand_over = db.Columb(db.Boolean, default=False)    # Indicates whether player has given up,
                                                        # has decided to stay or has gone over 21.
